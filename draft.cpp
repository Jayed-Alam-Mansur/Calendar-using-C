...
void intro()
{
	gotoXY(27,1); printf("PAYROLL MANAGEMENT SYSTEM");
    gotoXY(25,2); for(int i=0;i<29;i++) printf("%c",196);
    gotoXY(20,4); printf("Designed and Programmed by:");
    gotoXY(20,5);for(int i=0;i<29;i++) printf("%c",196);
	gotoXY(20,7); printf("Sagar Dhimal");
	gotoXY(20,8); printf("dhimalsagar00@gmail.com");
    getch();
